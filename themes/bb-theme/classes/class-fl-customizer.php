...
final class FLCustomizer {
	...
	static public function add_panel( $key, $data ) {
		/**
		 * The customizer panel data array before it is registered.
		 */
	...
	static public function controls_enqueue_scripts() {
		...
		/**
		 * Whether to enqueue the Select2 library in the Customizer.
		 */
	...
	static public function get_mods() {
		...
		/**
		 * The array of active theme mod values.
		 */
	...
	static public function get_cache_dir() {
		...
		/**
		 * The cache directory path and URL info array.
		 */
	...
	static public function _get_default_mods() {
		...
		/**
		 * The array of default theme mod values.
		 */
	...
	static private function _get_less_paths() {
		...
		$files  = array(
			...
			'northcommerce'            => defined( 'NORTH_COMMERCE_VERSION' ),
		);
		...
		/**
		 * The array of LESS file paths to compile into the theme skin CSS.
		 */
	...
	static public function _get_less_vars() {
		...
		$vars['content-link-decoration']       = $mods['fl-content-link-decoration'];
		$vars['content-link-decoration-hover'] = $mods['fl-content-link-decoration-hover'];
		...
		/**
		 * The array of LESS variable key/value pairs used when compiling the theme CSS.
		 */
