...
/**
 * Whether to show the full post content on archive pages instead of the excerpt.
 */
...
/**
 * Fires immediately before the post article element is rendered.
 */
...
<article <?php post_class( 'fl-post' ); ?> id="fl-post-<?php the_ID(); ?>"<?php FLTheme::print_schema( ' itemscope="itemscope" itemtype="https://schema.org/BlogPosting"' ); ?>>
	...
	<?php
	/**
	 * Fires immediately before the post content area is rendered.
	 */
	do_action( 'fl_before_post_content' );
	?>
	...
	<?php
	/**
	 * Fires immediately after the post content area is rendered.
	 */
	do_action( 'fl_after_post_content' );
	?>
...
<?php
/**
 * Fires immediately after the post article element is rendered.
 */
do_action( 'fl_after_post' );
?>
<!-- .fl-post -->
