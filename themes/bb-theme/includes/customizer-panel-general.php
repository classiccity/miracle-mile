	...
	'sections' => array(
				...
				'fl-framework'           => array(
					...
					'control' => array(
						...
						'choices'     => array(
							...
							'base'        => __( 'Minimal Bootstrap 3 (deprecated)', 'fl-automator' ),
							'bootstrap'   => __( 'Full Bootstrap 3 (deprecated)', 'fl-automator' ),
						),
					),
				),
		...
		'fl-heading-font' => array(
			...
			'options' => array(
				...
				'fl-h1-font-size'        => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H1 Font Size', 'fl-automator' ),
						'type'       => 'slider',
						'priority'   => 5.0,
				...
				'fl-h1-line-height'      => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H1 Line Height', 'fl-automator' ),
						'priority'   => 5.1,
						'type'       => 'slider',
						'choices'    => array(
							'min'  => 0.5,
				...
				'fl-h1-letter-spacing'   => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H1 Letter Spacing', 'fl-automator' ),
						'priority'   => 5.2,
						'type'       => 'slider',
						'choices'    => array(
							'min'  => -3,
				...
				'fl-h2-font-size'        => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H2 Font Size', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => get_font_size_limits(),
						'responsive' => true,
					),
				...
				'fl-h2-line-height'      => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H2 Line Height', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => array(
							'min'  => 0.5,
							'max'  => 2.5,
				...
				'fl-h2-letter-spacing'   => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H2 Letter Spacing', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => array(
							'min'  => -3,
							'max'  => 10,
				...
				'fl-h3-font-size'        => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H3 Font Size', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => get_font_size_limits(),
						'responsive' => true,
					),
				...
				'fl-h3-line-height'      => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H3 Line Height', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => array(
							'min'  => 0.5,
							'max'  => 2.5,
				...
				'fl-h3-letter-spacing'   => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H3 Letter Spacing', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => array(
							'min'  => -3,
							'max'  => 10,
				...
				'fl-h4-font-size'        => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H4 Font Size', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => get_font_size_limits(),
						'responsive' => true,
					),
				...
				'fl-h4-line-height'      => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H4 Line Height', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => array(
							'min'  => 0.5,
							'max'  => 2.5,
				...
				'fl-h4-letter-spacing'   => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H4 Letter Spacing', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => array(
							'min'  => -3,
							'max'  => 10,
				...
				'fl-h5-font-size'        => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H5 Font Size', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => get_font_size_limits(),
						'responsive' => true,
					),
				...
				'fl-h5-line-height'      => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H5 Line Height', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => array(
							'min'  => 0.5,
							'max'  => 2.5,
				...
				'fl-h5-letter-spacing'   => array(
					...
					'control' => array(
						...
						'label'      => __( 'H5 Letter Spacing', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => array(
							'min'  => -3,
							'max'  => 10,
				...
				'fl-h6-font-size'        => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H6 Font Size', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => get_font_size_limits(),
						'responsive' => true,
					),
				...
				'fl-h6-line-height'      => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H6 Line Height', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => array(
							'min'  => 0.5,
							'max'  => 2.5,
				...
				'fl-h6-letter-spacing'   => array(
					...
					'control' => array(
						'class'      => 'FLCustomizerControl',
						'label'      => __( 'H6 Letter Spacing', 'fl-automator' ),
						'type'       => 'slider',
						'choices'    => array(
							'min'  => -3,
							'max'  => 10,
		...
		'fl-body-font'    => array(
			...
			'options' => array(
				...
				/* Link Decoration */
				'fl-content-link-decoration'       => array(
					'setting' => array(
						'default' => 'none',
					),
					'control' => array(
						'class'   => 'WP_Customize_Control',
						'label'   => __( 'Link Decoration', 'fl-automator' ),
						'type'    => 'select',
						'choices' => array(
							'none'      => __( 'None', 'fl-automator' ),
							'underline' => __( 'Underline', 'fl-automator' ),
						),
					),
				),

				'fl-content-link-decoration-hover' => array(
					'setting' => array(
						'default' => 'underline',
					),
					'control' => array(
						'class'   => 'WP_Customize_Control',
						'label'   => __( 'Link Decoration Hover', 'fl-automator' ),
						'type'    => 'select',
						'choices' => array(
							'none'      => __( 'None', 'fl-automator' ),
							'underline' => __( 'Underline', 'fl-automator' ),
		...
		'fl-social-links' => array(
			...
			'options' => array(
				...
				'fl-social-soundcloud'        => array(
					'control' => array(
						'class' => 'WP_Customize_Control',
						'label' => __( 'Soundcloud', 'fl-automator' ),
					),
				),
				'fl-social-x-twitter'         => array(
					'control' => array(
						'class'       => 'WP_Customize_Control',
						'label'       => 'X (Twitter)',
						'description' => __( 'Font Awesome plugin is required for this icon set to 6.4.2 or higher', 'fl-automator' ),
					),
				),
				'fl-social-bluesky'           => array(
					'control' => array(
						'class'       => 'WP_Customize_Control',
						'label'       => __( 'Bluesky', 'fl-automator' ),
						'description' => __( 'Font Awesome plugin is required for this icon set to 6.5.2 or higher', 'fl-automator' ),
					),
				),
			),
		),
